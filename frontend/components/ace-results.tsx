  ...
  return (
    <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-2xl border border-white/50 max-h-[80vh] overflow-y-auto">
      ...
      <div className="flex flex-col items-center text-center mb-4">
        ...
        <h2 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-slate-800 to-blue-700 bg-clip-text text-transparent mb-2">
      ...
      {/* Results Card */}
      <div className={`bg-gradient-to-r ${resultData.color} ${resultData.borderColor} border rounded-2xl p-4 mb-4 shadow-lg`}>
        <div className="flex items-start gap-4">
          <div className="text-2xl md:text-3xl">{resultData.icon}</div>
          <div className="flex-1">
            <h3 className="text-lg md:text-xl font-bold text-slate-800 mb-2">{resultData.title}</h3>
      ...
      <div className="text-center">
        <Button
          onClick={onStartChat}
          className="bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white py-3 px-6 rounded-xl font-semibold shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105 text-base"
        >
