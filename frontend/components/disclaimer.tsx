  ...
  return (
    <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-2xl border border-white/50 max-h-[80vh] overflow-y-auto">
      ...
      <div className="flex flex-col items-center text-center mb-4">
        ...
        <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-slate-800 to-blue-700 bg-clip-text text-transparent mb-2">
          Meet Zoe
        </h1>
      ...
      <div className="space-y-3 mb-4">
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">AI-Powered Support</h3>
        ...
        <div className="bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-200 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-cyan-800 mb-1 text-sm">Professional Support</h3>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-green-800 mb-1 text-sm">Your Privacy Matters</h3>
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4">
        <Button
          onClick={onAccept}
          className="bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white px-8 py-3 rounded-xl font-medium shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105"
        >
